 ...
 * <p>
 * The package gui contains all the GUI classes. The class {@link de.neemann.digiblock.gui.Main} contains the
 * main method and the generation of the main frame. One of the more important class is
 * {@link de.neemann.digiblock.gui.components.CircuitComponent}. This class is used to draw the circuit.
 * <p>
 * There are two representations of the digital circuit. One is build up with
 * {@link de.neemann.digiblock.draw.elements.VisualElement} instances representing the elements in the circuit
 * and {@link de.neemann.digiblock.draw.elements.Wire} which simply represents a wire. The class
 * {@link de.neemann.digiblock.draw.elements.Circuit} contains a set of both elements.
 ...
 * <p>
 * The other representation of the digital circuit is build by the {@link de.neemann.digiblock.core.Node}
 * classes which you can find in the core package.
 * This classes form the simulation model represented by the {@link de.neemann.digiblock.core.Model} class.
 * Furthermore this representation is called the model.
 * In the package draw.model you can find the class {@link de.neemann.digiblock.draw.model.ModelCreator}.
 ...
 * <p>
 * The model consists only of {@link de.neemann.digiblock.core.Node}s. Such a nodes contain one or more
 * {@link de.neemann.digiblock.core.ObservableValue} instances which represent the inputs and outputs of the node.
 * To the ObservableValue you can register a {@link de.neemann.digiblock.core.Observer} instances. Every node
