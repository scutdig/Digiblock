 ...
 */
package de.neemann.digiblock.core.wiring.bus;

import de.neemann.digiblock.core.BurnException;
...
public abstract class AbstractBusHandler {
    ...
    /**
     * @return the resistor connected to the net, Dot return null, return {@link de.neemann.digiblock.core.element.PinDescription.PullResistor#none} instead.
     */
