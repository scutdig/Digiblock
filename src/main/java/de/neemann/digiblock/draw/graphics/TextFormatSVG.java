...
import de.neemann.digiblock.draw.graphics.text.formatter.SVGFormatter;
import de.neemann.digiblock.draw.graphics.text.text.Decorate;
import de.neemann.digiblock.draw.graphics.text.text.Text;
