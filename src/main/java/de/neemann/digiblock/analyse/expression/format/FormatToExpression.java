 ...
 */
package de.neemann.digiblock.analyse.expression.format;
...
import de.neemann.digiblock.draw.graphics.text.text.ExpressionToText;
 ...
 * At first the expression is converted to a {@link de.neemann.digiblock.draw.graphics.text.text.Text} instance and then
